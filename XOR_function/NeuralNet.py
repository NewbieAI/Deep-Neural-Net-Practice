...
class layer:
    ...
    #   respect ot the nodes, update the corresponding
    #   weights and bias
...
class dnn:
    ...
    # number of nodes should be created in the
    ...
    def learn(self,X,Y,learning_rate,iterations):
...
##    H[0,0]+=delta
##    g1 = x_entropy(H,Y)
##    print(gx_entropy(H,Y))
##    print((g1-g0)/delta)

    Y = np.array([1,0,1])
    H = np.random.randn(1,3)
    print(Y)
    print(H)
    g0 = x_entropy(H,Y)
    delta = 0.0000001
